...
const Footer = () => {
    return (
        <div className='bg-[#F6F9FC] text-gray-500/80 pt-6 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-8 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-3 h-8 md:h-9 invert opacity-80' />
                    <p className='text-sm'>
                ...
                <div>
                    <p className='font-playfair text-base text-gray-800'>COMPANY</p>
                ...
                <div>
                    <p className='font-playfair text-base text-gray-800'>SUPPORT</p>
                    <ul className='mt-2 flex flex-col gap-1.5 text-sm'>
                ...
                <div className='max-w-80'>
                    <p className='font-playfair text-base text-gray-800'>STAY UPDATED</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-4'>
                <p>© {new Date().getFullYear()} VoyageVista. All rights reserved.</p>
